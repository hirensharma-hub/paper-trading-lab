...
test("decision engine keeps an existing position on HOLD and uses exit policy for SELL", () => {
  const analysis = { symbol: "SPY", barCloseTimestamp: 1, decisionTimestamp: 1, timestamp: 1, features: {} as never, structure: null, regime: null, patterns: [], prediction: { predictionId: "p", modelId: "m", modelVersion: "1", featureSetVersion: "f", featureIds: [], targetVersion: "t", probability: 0.9, rawProbability: 0.9, calibratedProbability: 0.9, ood: { status: "IN_DISTRIBUTION" as const, maxAbsZ: 0 } }, evidence: { quality: "STRONG" as const, score: 1, components: {}, provenance: {} }, expectedValue: 1 };
