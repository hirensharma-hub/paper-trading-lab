...
export class IntelligenceEngine {
  ...
  constructor(private readonly config: IntelligenceConfig = {}) { if (config.model?.transformFeatures && config.analogueScaler) throw new Error("Feature transformation is ambiguous: provide either model transformFeatures or analogueScaler, not both"); }
