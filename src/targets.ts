...
export interface TargetResolution { targetVersion: string; targetKind: TargetKind; entryTimestamp: number; entryPrice: number; targetStartTimestamp: number; targetEndTimestamp: number; plannedTargetEndTimestamp: number; firstHitTimestamp?: number; resolutionTimestamp: number; label: "LONG" | "SHORT" | "FLAT" | "UP" | "DOWN" | "TIMEOUT" | "AMBIGUOUS"; forwardReturn: number; mfe: number; mae: number; }
