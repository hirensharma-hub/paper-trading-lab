...
Phase 1 — core correctness and reproducible research foundation.
...
- No licensed market-data adapter or local HTTP engine service exists yet.
- SQLite/IndexedDB persistence, event audit storage and a full UI/API contract remain future work.
