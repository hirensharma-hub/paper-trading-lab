...
| Offline experiment pipeline | Permitted offline research | CSV loader, manifest/hash/session/data-quality gates, point-in-time observations, strict label policy, chronological boundary purge, TRAIN fitting, validation/calibration/untouched TEST diagnostics, honest research reports, strict artifact persistence and synthetic/real CLI | IMPLEMENTED; historical validation pending permitted data |
